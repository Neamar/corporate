...
* Acheter une **part** dans une autre corpo coûte 100 000 ₵ par actifs de la corpo.
* Chaque part dans une autre corpo rapporte des dividendes : 50 000 ₵ par actifs de la corpo à la fin du tour. 
...
* Chaque part dans la corpo n°1 au classement rapporte des dividendes : 75 000 ₵ par actifs de la corpo
	...
	La corpo n°1 peut bien évidemment changer entre le moment où vous acehter votre part et la fin du tour.
...
> Notre club privé prône la générosité par dessus tout. Et quelle meilleur preuve de générosité qu'un chèque a une association ? Si si, l'ordre est à mon nom.
...
* Un joueur ne peut pas acheter plus de part que son IC à chaque tour. Par contre il n'y a pas de limite au nombre total de parts qu'un joueur peut avoir.
* On peut augmenter son IC en payant 750 000 ₵ par IC que l'on a déjà
...
* Un marché d'une corpo au hasard qui gagne 1 actif.
* Un marché d'une corpo au hasard qui perd 1 actif.

## Les Ordres
Évidemment, le jeu serait un peu fade si vous ne pouviez pas maîtriser un peu les cours de la bourse ! Vous disposez de 3 leviers : votre voix au chapitre sur les marchés, les opés et les coalitions.

### Voix au chapitre
> Quand je dis sur le réseau que je suis sur à 200% qu'un investissement sera rentable, une énorme masse d'argent se met en mouvement. Mais où étaient ils tous le jour du cours sur les statistiques ?
...
#### Opé de Sabotage
> Si on demandait à un enfant de dessiner un bon sabotage, il lui faudrait un bon crayon rouge.

Effet : En cas de réussite, le sabotage fait perdre 2 actifs au marché ciblé. 
Restriction : Vous ne pouvez pas cibler un marché à 0 ou moins.
Prix : 350 000 ₵ pour 50% de chances de réussir + 50 000 ₵ par tranche de 10% supplémentaires. Maximum 90%
Résolution : Les opés sont résolues par pourcentage de réussite décroissant. Une seule opé peut être réussie par marché et par corpo. À partir du moment où une opé est passé, les suivantes échouent automatiquement.

#### Opé de Datasteal
> Dans un monde où exploiter une idée est devenu un jeu d'enfant, les voler est devenu un travail d'adulte

Choisissez une corpo cible, une corpo bénéficiaire et un marché que les deux corpos partagent. 
Effet : En cas de réussite, le marché du bénéficiaire gagne +1 actif sur ce marché.
Restriction : Vous ne pouvez pas lancer cette opé si la corpo bénéficiaire possède strictement plus d'actifs dans le marché que la corpo cible.
Prix : 350 000 ₵ pour 50% de chances de réussir + 50 000 ₵ par tranche de 10% supplémentaires. Maximum 90%
Résolution : Les opés sont résolues par pourcentage de réussite décroissant. Une seule opé peut être réussie par marché et par corpo. À partir du moment où une opé est passé, les suivantes échouent automatiquement.

#### Opé d'Extraction
> Le dernier scientifique qu'on a recruté chez la concurrence avait peur des représailles mais je lui ai assuré que ça vallait le coup. On avait raison tous les deux : Il a perdu sa fille dans 'un accident' mais j'ai quand même doublé mon salaire.

Choisissez une corpo cible, une corpo bénéficiaire et un marché que les deux corpos partagent. 
Effet : En cas de réussite, -1 actif sur le marché cible et +1 actif sur le marché bénéficiare.
Restriction : Vous ne pouvez pas lancer cette opé si la corpo bénéficiaire possède strictement plus d'actifs dans le marché que la corpo cible.
Prix : 350 000 ₵ pour 50% de chances de réussir + 50 000 ₵ par tranche de 10% supplémentaires. Maximum 90%
Résolution : Les opés sont résolues par pourcentage de réussite décroissant. Une seule opé peut être réussie par marché et par corpo. À partir du moment où une opé est passé, les suivantes échouent automatiquement.
...
Les opés qui ciblent le marché protégé sont limités à 40% de réussite. 
Prix : 350 000 ₵

#### Opé d'Information
> La technologie est omniprésente et le concept de vie privée est inconnu des dernières générations. Cependant l'info n'est pas gratuite.

L'opé cible autant de joueurs et/ou corpos que l'on veut :
