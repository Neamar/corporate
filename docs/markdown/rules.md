...
Vous incarnez un cadre corporatiste décidé à se tailler un empire dans une des places financières les plus concurrentielles du 6ème monde : l’île de Manhattan.

##Concepts de base

Les *corporations, ou "corpos"*, sont au coeur du jeu. De gigantesques multinationales qui ont supplanté le pouvoir des nations et fait main basse sur l'économie planétaire. Elles sont innombrables, mais le Corporate Game (*CG*) ne tient compte que des 10 plus grosses s’étant implantées à Manhattan.

La taille de ces 10 corpos est représentée par leur nombre d'*actifs*, qui évoluera en fonction des actions des joueurs et des caprices du marché. Plus une corpo possède d'actifs, plus elle engrange de bénéfices. Une corpo à 0 actifs à la fin d'un tour crashe définitivement. Au début de la partie, les actifs des 10 corpos sont tirés au hasard. (cf mise en place)
...
3) Chaque corpo est différente, et possède un *effet premier*, qui s'applique lorsque la corpo est en tête du classement, et un *effet dernier*, qui s'applique lorsque qu'elle est dernière du classement. Les deux effets sont résolus simultanément, lorsque tous les autres modificateurs ont été appliqués.

4) Chaque joueur touche ses divers retours sur investissement.
...
Une part coûte (100 000 ny) x (actifs de la corpo). Soit 500 000 ny pour une corpo de 5 actifs. 

`Une part dans la corpo en tête du classement (rang 1) coûte 125 000 ny x actifs pour joueurs qui n’en ont pas la nationalité (cf citoyenneté corpo)

À la fin de chaque tour, les joueurs touchent les *dividendes* de leurs parts. Chaque part rapporte à son propriétaire (50 000 ny) x actifs de la corpo. Un joueur possédant 2 parts dans une corpo de 5 actifs et 1 part dans une corpo de 10 actifs touchera donc : (2 x 50 000 x 5 + 1 x 50 000 x 10), soit 1 million de ny.

`Les parts de la corpo en tête du classement rapportent 75 000 ny x actifs.
`Les parts de la dernière corpo rapportent 25 000 ny x actifs.
...
* Paye les parts de sa corpo au prix usuel de (100 000 ny) x actifs même si elle est en tête du classement (au lieu de (125 000 ny) x actifs).
...
Il existe 5 type de runs, *Datasteal*, *Sabotage*, *Extraction*, *Information* et *Protection*, qui ont chacune des résultats spécifiques et une chance de réussite de base en pourcentage (%) ; 30% pour les runs de Sabotage, par exemple. Le joueur *commanditaire* peut augmenter les chances de réussite de sa run à raison de 50 000 ny pour 10% supplémentaire. Un joueur qui investit 150 000 ny dans une run de Sabotage aura donc 60% de chance de la voir réussir (30% de base + 3 x 10%).
...
Une run détectée est également publiée dans le rapport public de fin de tour, mais sans préciser le commanditaire et la chance de réussite.
...
Les joueurs qui veulent miser dans le grand casino de l’East Coast Stock Exchange peuvent effectuer un nombre de *spéculations* par tour égal à leur IC. Le montant de chaque spéculation ne peut dépasser (50 000 ny) x IC du spéculateur. Il est possible d’effectuer la même spéculation plusieurs fois.
...
* 2 fois la somme misée s'il a spéculé qu’une corpo finirait le tour *première ou dernière* -- soit cote de *1 pour 3*.
* 4 fois la somme misée s’il a spéculé qu’une corpo finirait le tour à un autre rang (*de deuxième à avant-dernière*) -- soit cote de *1 pour 5*.
...
Les corpos membres ont changées plusieurs fois depuis la fin de la reconstruction.  Aujourd'hui, elles sont treize*, et ont chacune une voix lors des votes du consortium. Ces votes légifèrent sur tous les aspects de la vie et des affaires à Manhattan, des juteux contrats de la voirie, de la sécurité, du traitement des déchets ou du développement de la matrice aux lois de régulations des marchés qui ont le potentiel de bouleverser le cours des actions des corpos les plus stables. Les votes du MDC rythment la vie politique de Manhattan, et sont disputés par des coalitions fluctuantes qui ne reculent devant aucun coup bas pour rafler la mise.
...
Effet
* Au prochain tour, les spéculations des *joueurs* ayant voté *Dérégulation* voient les *côte augmentées de 1* (1 pour 2 devient 1 pour 3, 1 pour 5 devient 1 pour 6...)
...
* : les 10 du Classement, plus NYPD Incorporated, Citigroup et Transys Orbital, qui ne sont pas représentées pour l'instant. Prochaine partie peut-être ;).
