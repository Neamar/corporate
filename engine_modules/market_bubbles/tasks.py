...
class UpdateMarketBubblesAfterEffectsTask(UpdateMarketBubblesTask):
	...
	def run(self, game):
		...
		for deleted_bubble in previous_turn_bubbles:
			...
			game.add_event(event_type=event_type, data={"market": deleted_bubble.market.name, "corporation": deleted_bubble.corporation.base_corporation.name}, corporation=deleted_bubble.corporation, corporation_market=corporation_market)
		...
		for added_bubble in current_turn_bubbles:
			...
			game.add_event(event_type=event_type, data={"market": added_bubble.market.name, "corporation": added_bubble.corporation.base_corporation.name}, corporation=added_bubble.corporation, corporation_market=corporation_market)
