...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('category', models.CharField(max_length=15, choices=[(b'1-detroit-inc', b'Bulletin de Detroit, Inc.'), (b'4-matrix-buzz', b'Matrix Buzz'), (b'3-people', b'Flash People'), (b'2-economy', b'\xc3\x89conomie')])),
                ('content', models.TextField(blank=True)),
                ('turn', models.PositiveSmallIntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('category', models.CharField(default=b'global', max_length=15, choices=[(b'global', 'Global'), (b'runs', 'Runs'), (b'detroit-inc', 'Detroit, Inc.'), (b'speculation', 'Sp\xe9culations'), (b'dividend', 'Dividendes')])),
                ('content', models.TextField(blank=True)),
                ('turn', models.PositiveSmallIntegerField()),
                ('recipient_set', models.ManyToManyField(to='engine.Player')),
            ],
